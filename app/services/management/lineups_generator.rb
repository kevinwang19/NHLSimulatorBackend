...
module Management
    class LineupsGenerator
        ...
        def save_lineups_data(team_id, players)
            ...
            offensive_forwards_order = forwards.sort_by { |forward| -(forward["offensiveRating"] || 0) }
            defensive_forwards_order = forwards.sort_by { |forward| -(forward["defensiveRating"] || 0) }
            valid_forwards = forwards.select { |forward| (forward["offensiveRating"] || 0) + (forward["defensiveRating"] || 0) != 0 }
            ...
            offensive_defensemen_order = defensemen.sort_by { |defenseman| -(defenseman["offensiveRating"] || 0) }
            defensive_defensemen_order = defensemen.sort_by { |defenseman| -(defenseman["defensiveRating"] || 0) }
            valid_defensemen = defensemen.select { |defenseman| (defenseman["offensiveRating"] || 0) + (defenseman["defensiveRating"] || 0) != 0 }
            ...
            valid_goalies = goalies.select { |goalie| (goalie["defensiveRating"] || 0) != 0 }
